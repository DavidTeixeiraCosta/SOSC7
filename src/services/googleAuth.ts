...
// Cache token strictly in memory - NEVER in localStorage/sessionStorage
  ...
  return onAuthStateChanged(auth, async (user: User | null) => {
    if (user) {
      if (cachedAccessToken) {
        ...
        // User logged in on Firebase, but access token might not be refreshed yet.
        // If cached token is null, keep user state or trigger prompt when needed
